...
public class CopyCheckBox extends View {
    ...
    public CopyCheckBox(Context context) {
        super(context);
        initView(context);
    }

    public CopyCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        customImage = context.getResources().getDrawable(R.drawable.copy);
    }

    public CopyCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(Context context) {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setChecked(!checked);
                onCheckedChangeListener.onCheckedChanged(CopyCheckBox.this, isChecked());
            }
        };
